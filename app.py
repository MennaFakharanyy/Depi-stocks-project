...
page = st.sidebar.radio("Go to", ["Home", "EDA", "Real-time Prediction", "About"])
...
if page == "Home":
    ...
    # ------------------------
    # 3️⃣ Auto Live Prediction (Multiple Stocks, Auto-Refresh)
    # ------------------------
        ...
        count = st_autorefresh(interval=300_000, key="auto_refresh")
